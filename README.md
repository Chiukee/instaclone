...
- [x] I want to make it so that after the user logs out they automatically return to the login screen
## Video Walkthrough
...
I had a lot of trouble trying to get the camera to work
